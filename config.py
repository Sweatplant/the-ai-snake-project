...
GRID_HEIGHT = 10
CELL_SIZE = 30
FPS = 100                         # Simulation speed (set 0 for max speed)
RENDERER_ENABLED = True        # Enable or Disable game rendering
TRAINING_ENABLED = False         # Enable or Disable training (for RL agents)
...
REWARD_NOTHING = -0.1          # Reward/penalty for just doing nothing
...
TABULAR_EPSILON_DECAY = 0.995   # Exploration rate decay
...
DQN_EPSILON_DECAY = 0.997       # Exploration rate decay
DQN_EPSILON_MIN = 0.02          # Residual exploration rate
DQN_BATCH_SIZE = 64             # Batch size for training
DQN_BUFFER_CAPACITY = 50000     # Replay buffer capacity
